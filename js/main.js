...
const ALL_RECIPES = [
  ...
  { title: 'Italian S Cookies', img: 'images/italian-s-cookies.jpg', desc: 'S-shaped northern Italian butter cookies, scented with lemon', tags: ['Cookie','Italy','Sweet','Easy'], page: 'recipe-pages/italian-s-cookies.html', popular: false, date: '2026-07-01' },
  ...
  { title: 'French Macaron', img: 'images/french-macarons.jpg', desc: 'Delicate almond-meringue shells with a ganache filling', tags: ['Pastry','France','Sweet','Hard'], page: 'recipe-pages/french-macarons.html', popular: false },
  { title: 'Danish Butter', img: 'images/danish-butter-cookies.jpg', desc: 'The Danish classic — rich, buttery, and snappingly crisp', tags: ['Cookie','Denmark','Sweet','Easy'], page: 'recipe-pages/danish-butter-cookies.html', popular: false },
  ...
  { title: 'Apple Strudel', img: 'images/apple-strudel.jpg', desc: 'Viennese Apfelstrudel — spiced apples in paper-thin pastry', tags: ['Pastry','Austria','Sweet','Moderate'], page: 'recipe-pages/apple-strudel.html', popular: true },
  { title: 'Gingerbread', img: 'images/gingerbread-cookies.jpg', desc: 'A winter classic spiced with ginger, cloves, and molasses', tags: ['Cookie','Germany','Sweet','Easy'], page: 'recipe-pages/gingerbread-cookies.html', popular: false },
  ...
  { title: 'New York Cheesecake', img: 'images/new-york-cheesecake.jpg', desc: 'Dense, ultra-creamy, and smooth — the New York classic', tags: ['Cake','USA','Sweet','Moderate'], page: 'recipe-pages/new-york-cheesecake.html', popular: false },
  { title: 'Croissant', img: 'images/croissant.jpg', desc: 'Flaky, buttery laminated crescents, an emblem of French baking', tags: ['Pastry','France','Sweet','Moderate'], page: 'recipe-pages/croissant.html', popular: false },
  { title: 'Vanillekipferl', img: 'images/vanillekipferl.jpg', desc: 'Austrian Christmas crescents — almond shortbread in vanilla sugar', tags: ['Cookie','Austria','Sweet','Moderate'], page: 'recipe-pages/vanillekipferl.html', popular: false, date: '2026-08-29' },
  ...
  { title: 'Sachertorte', img: 'images/sachertorte.jpg', desc: "Vienna's dense chocolate cake with apricot jam and a dark glaze", tags: ['Cake','Austria','Sweet','Hard'], page: 'recipe-pages/sachertorte.html', popular: false, date: '2026-09-09' },
];
