...
const ALL_RECIPES = [
  ...
  { title: 'Crêpe', img: 'images/crepe.jpg', desc: 'Thin, lacy pancakes from Brittany, sweet or savory', tags: ['Breakfast','France','Sweet','Easy'], page: 'recipe-pages/crepe.html', popular: false },
  { title: 'Chocolate Soufflé', img: 'images/chocolate-souffle.jpg', desc: 'Deep, dark chocolate and impossibly airy, served warm', tags: ['Pastry','France','Sweet','Moderate'], page: 'recipe-pages/chocolate-souffle.html', popular: false },
  { title: 'Cupcake', img: 'images/cupcake.jpg', desc: 'Small single-serve cakes under a swirl of frosting', tags: ['Pastry','USA','Sweet','Moderate'], page: 'recipe-pages/cupcake.html', popular: false },
  ...
  { title: 'French Macaron', img: 'images/french-macarons.jpg', desc: 'Delicate almond-meringue shells filled with ganache', tags: ['Pastry','France','Sweet','Hard'], page: 'recipe-pages/french-macarons.html', popular: false },
  { title: 'Danish Butter', img: 'images/danish-butter-cookies.jpg', desc: 'Rich, snappingly crisp butter cookies with a vanilla note', tags: ['Cookie','Denmark','Sweet','Easy'], page: 'recipe-pages/danish-butter-cookies.html', popular: false },
  { title: 'Chocolate Chip Cookie', img: 'images/chocolate-chip-cookies.jpg', desc: 'Buttery brown-sugar dough loaded with chocolate chips', tags: ['Cookie','USA','Sweet','Easy'], page: 'recipe-pages/chocolate-chip-cookies.html', popular: true },
  ...
  { title: 'Gingerbread', img: 'images/gingerbread-cookies.jpg', desc: 'Cut-out cookies spiced with ginger, cloves, and molasses', tags: ['Cookie','Germany','Sweet','Easy'], page: 'recipe-pages/gingerbread-cookies.html', popular: false },
  ...
  { title: 'New York Cheesecake', img: 'images/new-york-cheesecake.jpg', desc: 'Dense, ultra-creamy and tall — the New York classic', tags: ['Cake','USA','Sweet','Moderate'], page: 'recipe-pages/new-york-cheesecake.html', popular: false },
  { title: 'Croissant', img: 'images/croissant.jpg', desc: 'Flaky, buttery French crescents from laminated dough', tags: ['Pastry','France','Sweet','Moderate'], page: 'recipe-pages/croissant.html', popular: false },
