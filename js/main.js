...
const ALL_RECIPES = [
  ...
  { title: 'Chocolate Soufflé', img: 'images/chocolate-souffle.jpg', desc: 'Deep chocolate, impossibly airy — the French classic', tags: ['Pastry','France','Sweet','Moderate'], page: 'recipe-pages/chocolate-souffle.html', popular: false },
  ...
  { title: 'Danish Butter', img: 'images/danish-butter-cookies.jpg', desc: 'Rich, buttery, snappingly crisp', tags: ['Cookie','Denmark','Sweet','Easy'], page: 'recipe-pages/danish-butter-cookies.html', popular: false },
  ...
  { title: 'Apple Strudel', img: 'images/apple-strudel.jpg', desc: 'Spiced apples in paper-thin Viennese pastry', tags: ['Pastry','Austria','Sweet','Moderate'], page: 'recipe-pages/apple-strudel.html', popular: true },
  { title: 'Gingerbread', img: 'images/gingerbread-cookies.jpg', desc: 'Spiced with ginger, cloves, and molasses', tags: ['Cookie','Germany','Sweet','Easy'], page: 'recipe-pages/gingerbread-cookies.html', popular: false },
  { title: 'French Toast', img: 'images/french-toast.jpg', desc: 'Custard-soaked bread, crisp then tender', tags: ['Breakfast','France','Sweet','Easy'], page: 'recipe-pages/french-toast.html', popular: true },
  { title: 'Pizza', img: 'images/pizza.jpg', desc: 'Blistered Naples crust, tomato, mozzarella', tags: ['Pastry','Italy','Salty','Easy'], page: 'recipe-pages/pizza.html', popular: true },
  { title: 'New York Cheesecake', img: 'images/new-york-cheesecake.jpg', desc: 'Dense, ultra-creamy — the New York classic', tags: ['Cake','USA','Sweet','Moderate'], page: 'recipe-pages/new-york-cheesecake.html', popular: false },
  { title: 'Croissant', img: 'images/croissant.jpg', desc: 'Flaky, buttery laminated French crescents', tags: ['Pastry','France','Sweet','Moderate'], page: 'recipe-pages/croissant.html', popular: false },
  { title: 'Vanillekipferl', img: 'images/vanillekipferl.jpg', desc: 'Almond-shortbread crescents in vanilla sugar', tags: ['Cookie','Austria','Sweet','Moderate'], page: 'recipe-pages/vanillekipferl.html', popular: false, date: '2026-08-29' },
  { title: 'Gevulde Koek', img: 'images/gevulde-koek.jpg', desc: 'Shortcrust cookies filled with almond paste', tags: ['Cookie','Netherlands','Sweet','Moderate'], page: 'recipe-pages/gevulde-koek.html', popular: false, date: '2026-09-08' },
  { title: 'Sachertorte', img: 'images/sachertorte.jpg', desc: "Dense chocolate cake, apricot jam, dark glaze", tags: ['Cake','Austria','Sweet','Hard'], page: 'recipe-pages/sachertorte.html', popular: false, date: '2026-09-09' },
];
